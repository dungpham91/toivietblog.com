	...
	<div id="commentsAdd">
		<div id="respond" class="box m-t-6">
			<?php global $aria_req; 
				...
				$comments_args = array(
				'title_reply'=>__('Got something to say? Join the discussion','ribbon-lite'),
				'label_submit' => __('Post Comment','ribbon-lite'),
				...
				'fields' => apply_filters( 'comment_form_default_fields',
                    array(
                        'author' => '<div class="comment-form-container"><p class="comment-form-author">' . '<label for="author">' . __( 'Name (*) ', 'ribbon-lite' ) . ':<span class="required">*</span></label>' . ( $req ? '' : '' ) .
                            '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>',

                        'email' => '<p class="comment-form-email"><label for="email">' . __( 'Email Address (*) ', 'ribbon-lite' ) . ':<span class="required">*</span></label>' . ( $req ? '' : '' ) .
